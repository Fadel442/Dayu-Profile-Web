...
@section('konten')
    ...
    <div class="relative w-full h-full">
        <div class="absolute inset-0 bg-center bg-cover bg-no-repeat w-full h-[75%]"
            style="background-image: url('/gambar/background skill.png'); z-index: -1;">
            <!-- Background di bawah -->
        </div>
        <div class="relative z-10">
            <!-- Konten di atas background -->
            <div class="py-24">
                ...
                <div class="flex w-full justify-between py-10">
                    <div class="max-w-sm h-[480px] p-6 bg-white border border-cl-pink rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 flex flex-col items-center mx-16">
